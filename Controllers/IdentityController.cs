  ...
  public class IdentityController : Controller
  {
    ...
    public IActionResult Index()
    {
      ...
      return View();
        ...
        [HttpPost]
        public async Task<IActionResult> UploadIdentityCard(IFormFile file, string sampleFilePath)
        {
            ...
            else if (!string.IsNullOrEmpty(sampleFilePath))
            {
                ...
                {
                    TempData["Error"] = $"Sample identity card not found: {sourcePath}";
                }
            }
            else
            {
                TempData["Error"] = "Please upload or select a sample identity card.";
            }
